function ColorPicker() {
    this.colorPalette    = $('.color-palette4 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider4 canvas').get(0);
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector4').on('mousedown touchstart', function(e) {
        clicked = true;
