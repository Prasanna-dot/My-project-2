function ColorPicker() {
    this.colorPalette    = $('.color-palette15 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider15 canvas').get(0);
    ...
    this.selectColor = function() {
      ...
      $('.color-palette15 .selector15 ').css({
        'background': rgb,
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector15').on('mousedown touchstart', function(e) {
        clicked = true;
