function ColorPicker() {
    this.colorPalette    = $('.color-palette14 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider14 canvas').get(0);
    ...
    this.selectColor = function() {
      ...
      $('.color-palette14 .selector14 ').css({
        'background': rgb,
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector14').on('mousedown touchstart', function(e) {
        clicked = true;
