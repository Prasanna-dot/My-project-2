function ColorPicker() {
    this.colorPalette    = $('.color-palette3 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider3 canvas').get(0);
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector3').on('mousedown touchstart', function(e) {
        clicked = true;
