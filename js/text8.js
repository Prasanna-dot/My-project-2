function ColorPicker() {
    this.colorPalette    = $('.color-palette8 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider8 canvas').get(0);
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector8').on('mousedown touchstart', function(e) {
        clicked = true;
