function ColorPicker() {
    this.colorPalette    = $('.color-palette6 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider6 canvas').get(0);
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector6').on('mousedown touchstart', function(e) {
        clicked = true;
