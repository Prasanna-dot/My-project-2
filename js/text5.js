function ColorPicker() {
    this.colorPalette    = $('.color-palette5 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider5 canvas').get(0);
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector5').on('mousedown touchstart', function(e) {
        clicked = true;
