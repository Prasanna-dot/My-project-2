function ColorPicker() {
    this.colorPalette    = $('.color-palette9 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider9 canvas').get(0);
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector9').on('mousedown touchstart', function(e) {
        clicked = true;
