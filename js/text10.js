function ColorPicker() {
    this.colorPalette    = $('.color-palette10 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider10 canvas').get(0);
    ...
    this.selectColor = function() {
      ...
      $('.color-palette10 .selector10 ').css({
        'background': rgb,
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector10').on('mousedown touchstart', function(e) {
        clicked = true;
