function ColorPicker() {
    this.colorPalette    = $('.color-palette1 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider1 canvas').get(0);
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector1').on('mousedown touchstart', function(e) {
        clicked = true;
