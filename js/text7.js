function ColorPicker() {
    this.colorPalette    = $('.color-palette7 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider7 canvas').get(0);
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector7').on('mousedown touchstart', function(e) {
        clicked = true;
