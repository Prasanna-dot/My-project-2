function ColorPicker() {
    this.colorPalette    = $('.color-palette12 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider12 canvas').get(0);
    ...
    this.selectColor = function() {
      ...
      $('.color-palette12 .selector12 ').css({
        'background': rgb,
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector12').on('mousedown touchstart', function(e) {
        clicked = true;
