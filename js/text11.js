function ColorPicker() {
    this.colorPalette    = $('.color-palette11 canvas').get(0);
    this.colorPaletteCtx = this.colorPalette.getContext('2d');
  
    this.colorSlider = $('.color-slider11 canvas').get(0);
    ...
    this.selectColor = function() {
      ...
      $('.color-palette11 .selector11 ').css({
        'background': rgb,
    ...
    this.createColorPalette = function(color) {
      ...
      $('.selector11').on('mousedown touchstart', function(e) {
        clicked = true;
